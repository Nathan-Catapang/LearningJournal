# CS50P Learning Log LEARNING

### Day 1 (May 16, 2026)
- Started the CS50P course.
- Set up my repository and local environment.

### Day 2 (May 18, 2026)
- Started Week 0 on functions and variables.
- Checked that my coding tools and terminal work right.
- Wrote a basic script that takes user input.
- Fixed errors with text and numbers.
